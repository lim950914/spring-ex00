...
public class Ex02Controller {
	...
	public void method3(@RequestParam("id") String idparam) {
		log.info("ex02, sub03 method");
		log.info(idparam);
	}
	
	@RequestMapping("/sub04")
	public void memthod04(@RequestParam("id") String idparam, @RequestParam("age") String ageParam) {
	...
	public void method05(@RequestParam String id, @RequestParam String age) {
...
//		int age = Integer.parseInt(request.getParameter("age"));
	...
	public void memthod08(@RequestParam List<String> fav) {
		log.info("ex02 stb08 method");
